import {
  ...
  toBlobSidecars,
  toRlp
} from "./chunk-YOPKBHWR.js";
import {
  secp256k1
} from "./chunk-PTWHRQFY.js";
import {
  HashMD
} from "./chunk-CRYBMUGN.js";
import {
  addressResolverAbi,
  call,
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-LGBDQWGZ.js");
  const signature_ = (() => {
...
function ripemd1604(value, options = {}) {
  const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
  const bytes = ripemd1603(from(value));
  if (as === "Bytes")
    return bytes;
  return fromBytes2(bytes);
}
...
*/
//# sourceMappingURL=chunk-D7FM2BMZ.js.map
